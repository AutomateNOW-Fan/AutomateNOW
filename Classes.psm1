...
Enum ANOWApplicationConfiguration_documentationBaseUrlType {
    OLD; NEW;
}
...
Class ANOWApplicationConfiguration : Base {
    ...
    [ANOWApplicationConfiguration_documentationBaseUrlType]$documentationBaseUrlType
...
Class ANOWMigrationImport : Base {
    ...
    [string]$comment
    [string]$reason
    [string]$designImportOperationStatus
    [string]$designImportOperationType
...
Class ANOWProcessingEvent : Base {
    [string]$agent
    [ANOWProcessingEvent_agentOperatingSystemType]$agentOperatingSystemType
    ...
    [datetime]$dateCreated
    [string]$domain
    [ANOWProcessingEvent_eventCategory]$eventCategory
    ...
    [string]$id
    [boolean]$killed
    [ANOWProcessingEvent_killMode]$killMode
    [ANOWProcessingEvent_monitorType]$monitorType
    [string]$objectId
    [string]$objectName
    ...
    [string]$processingName
    [string]$processingTemplate
    [ANOWProcessingEvent_processingType]$processingType
    [string]$processingWarningMessage
    [ANOWProcessingEvent_processingWarningType]$processingWarningType
    [string]$reason
    [string]$resource
    [string]$resourceSimpleId
    [ANOWProcessingEvent_resourceType]$resourceType
    [string]$rootName
    [int64]$rootProcessingId
    [string]$rootTemplate
    [ANOWProcessingEvent_sensorType]$sensorType
    [string]$serverNode
    [string]$serverNodeSimpleId
    [ANOWProcessingEvent_serverNodeType]$serverNodeType
    [ANOWProcessingEvent_serviceManagerType]$serviceManagerType
    [ANOWProcessingEvent_serviceType]$serviceType
    [string]$targetState
    [ANOWProcessingEvent_taskType]$taskType
    [int64]$timesRestarted
    [datetime]$timestamp
    [ANOWProcessingEvent_triggerType]$triggerType
    [string]$userId
    [ANOWProcessingEvent_workflowType]$workflowType
    [string]$workspace
...
Class ANOWProcessingTemplateAction : Base {
    ...
    [ANOWWorkflowTemplate]$workflow # [sic]
