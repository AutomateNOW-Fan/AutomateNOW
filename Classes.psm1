...
#Region - Enum [ANOWApplicationConfiguration]
...
Enum ANOWDomain_secretVaultType {
    HASHI_CORP; AZURE; CYBER_ARK; CYBER_ARK_CONJUR;
}
...
Class ANOWCalendar : ANOWResource {
    ...
    ANOWCalendar([ANOWResource]$baseObject) {
        ...
        $this.shiftCalendar = $baseObject.semaphoreState
