...
Enum ANOWAgent_openTelemetryExporterType {
    # This is a custom class for the agent telemetry exporter types
    HTTP; GPRC; ANOW;
}
...
Enum ANOWApplicationConfiguration_oauthClientAuthMethod {
    CLIENT_SECRET; CLIENT_CERTIFICATE;
}

Enum ANOWApplicationConfiguration_systemStatusMessageType {
...
#region - Enum [BusinessViewItem] * Custom Class
...
Enum ANOWCodeRepositoryObjectSourceCode_domainClassName {
    # The entry for 'ProcessingTemplateItem' was added to support object referrals
    AdhocReport; Agent; Anomaly; ApprovalConfiguration; BusinessView; Dashboard; DataSource; Endpoint; Folder; Integration; ItemList; NotificationChannel; NotificationGroup; NotificationMessageTemplate; ProcessingAction; ProcessingTemplate; ProcessingTemplateChangeRequest; ProcessingTemplateItem; Resource; ResultMapping; SelfServiceTemplate; ServerNode; ServerNodeGroup; Tag; UserReport; Workspace;
}
...
#region - Enum [Migration Import] * Custom Class
...
Enum ANOWProcessing_waitingReason {
    WAITING_INIT; WAITING_TIME; WAITING_TIME_TRIGGER; WAITING_PARENT; WAITING_RESUME; WAITING_DEPENDENCY; WAITING_RESOURCES; WAITING_SERVER_NODE; WAITING_SCRIPT; WAITING_PRESCRIPT; WAITING_SIMULTANEOUS_EXECUTION
}
...
Enum ANOWProcessingContextVariable_sourceType {
    USER; INPUT_PARAMETER; PROCESSING; PROCESSING_ACTION; PROCESSING_AE; SERVER_NODE_ACTION; RESOURCE;
}
...
#region - Enum [Processing State] * Custom Class
...
Enum ANOWResource_calendarCyclicPeriodType {
    WEEKDAY_OF_YEAR_NO_RESET; WEEKDAY_OF_MONTH; DAY_OF_MONTH; WEEKDAY_OF_YEAR; DAY_OF_YEAR; DAY_OF_YEAR_NO_RESET; DATE_OF_YEAR;
}
...
Class ANOWAgent : ANOW {
    ...
    [int64]$agentDiskFreeMemory
    [int64]$agentDiskMemoryUsage
    [string]$agentMacAddress
    [int64]$agentDiskTotalMemory
    [int64]$agentFreeMemory
    [int64]$agentMemoryUsage
...
Class ANOWApplicationConfiguration : Base {
    ...
    [string]$oauthCertificateAlias
    [string]$oauthCertificateFilePath
    [string]$oauthCertificateKeyStoreType
    [string]$oauthCertificatePassword
    [ANOWApplicationConfiguration_oauthClientAuthMethod]$oauthClientAuthMethod
    [string]$samlAdminGroup
    [string]$samlGroupAttribute
    [boolean]$samlSpInitiated
    [boolean]$showSystemStatusMessage
    [string]$systemStatusMessage
    [System.Nullable[datetime]]$systemStatusMessageEndDate
    [System.Nullable[datetime]]$systemStatusMessageStartDate
    [ANOWApplicationConfiguration_systemStatusMessageType]$systemStatusMessageType
...
Class ANOWProcessing : Base {
    ...
    [boolean]$forceLoad
    [boolean]$forceReady
    [boolean]$completeOnMaxSimultaneousExecutions
    [boolean]$failOnMaxSimultaneousExecutions
    [boolean]$hasActions
    [boolean]$hasChildren
    ...
    [boolean]$simultaneousExecutionAcquired
    [boolean]$simultaneousExecutionQueued
    ...
    [boolean]$skipTriggerTagsOnProcessingExecution
    [boolean]$stopped
    ...
    [int64]$duration
    [int64]$estimatedDuration
    [int64]$maxSimultaneousExecutions
    ...
    [int64]$parent
    [int64]$pendingNoteCount
    [string]$priority # this needs to be a string (don't ask)
...
Class ANOWSchedule : ANOWProcessing {
    ...
    ANOWSchedule([ANOWProcessing]$baseObject) {
        ...
        $this.failOnMaxSimultaneousExecutions = $baseObject.failOnMaxSimultaneousExecutions
        $this.maxSimultaneousExecutions = $baseObject.maxSimultaneousExecutions
        $this.simultaneousExecutionAcquired = $baseObject.simultaneousExecutionAcquired
        $this.simultaneousExecutionQueued = $baseObject.simultaneousExecutionQueued
        $this.skipTriggerTagsOnProcessingExecution = $baseObject.skipTriggerTagsOnProcessingExecution
    }
}
...
Class ANOWProcessingContextVariable : Base {
    ...
    [boolean]$archived
    [string]$source
    [Nullable[ANOWProcessingContextVariable_sourceType]]$sourceType
    [System.Nullable[datetime]]$dateCreated
    [System.Nullable[datetime]]$lastUpdated
    [string]$domain

    # below are properties which were known to once be in the schema but are not currently returned by the API - keeping them here just in case they come back in the future, as it will be easier to add them back in
    #[string]$lastUpdatedBy
...
Class ANOWScheduleTemplate : ANOWProcessingTemplate {
    ...
    ANOWScheduleTemplate([ANOWProcessingTemplate]$baseObject) {
        ...
        $this.completeOnMaxSimultaneousExecutions = $baseObject.completeOnMaxSimultaneousExecutions
        ...
        $this.passBy = $baseObject.passBy
        $this.passResourceDependenciesToChildren = $baseObject.passResourceDependenciesToChildren
        $this.pendingBy = $baseObject.pendingBy
        $this.pendingNoteCount = $baseObject.pendingNoteCount
        $this.postScript = $baseObject.postScript
